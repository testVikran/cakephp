...
<div class="row">
    <div class="col-xs-6">
        <div>
            <a onclick="ga('send', 'event', 'Registration', 'Sign in with Facebook');" href="<?php echo $this->Html->url(array("controller" => "facebookApp", "action" => "fblogin" . $addParameters)); ?>" class="btn btn-social btn-block btn-facebook smallSocialBtn btn-bordered-facebook">
    ...
    <div class="col-xs-6">
        <div>
            <a onclick="ga('send', 'event', 'Registration', 'Sign up with LinkedIn');" href="<?php echo $this->Html->url(array("controller" => "linkedins", "action" => "index" . $addParameters)); ?>" class="btn btn-social btn-block btn-linkedin smallSocialBtn btn-bordered-linkedin">
...
<form action="<?php echo ABSOLUTE_URL?>/registration" method="post" role="form" novalidate="novalidate" class="bv-form" id="JsLoginRegistrationForm" accept-charset="utf-8">
    ...
    <div id="hh_signup">
        ...
        <div class="form-group <?php echo $error ?>">
            ...
            <input type="text" class="form-control" name="data[JsLogin][emailid]" title="Please enter your email" id="JsLoginEmailid" onchange="hideError()" value="<?php echo $content['email']?>">
        ...
        <div class="form-group <?php echo $errorM; ?>">
            ...
            <div class="mobile-input-box width-80perc pull-left  margin-left-minus-3" id="mNumber">
                <input name="data[JsLogin][mobile_number]" class="form-control"  id="mobile-number" maxlength="20" type="text" data-bv-field="data[JsLogin][mobile_number]" title="Your Mobile Number" onchange="hideError()" value="<?php echo $content['mobileNumber']?>">
            </div> 
